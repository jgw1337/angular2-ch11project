System.register(['angular2/core', 'angular2/router', './album.component', './albums.component', './contact.component'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AppSPAComponent = (function () {
                function AppSPAComponent() {
                }
                AppSPAComponent = __decorate([
                    ...
                    core_1.Component({
                        selector: 'my-app',
                        templateUrl: '/app/app-singlepageapp.component.html',
                        directives: [router_1.ROUTER_DIRECTIVES]
                    }), 
                    __metadata('design:paramtypes', [])
                ], AppSPAComponent);
                return AppSPAComponent;
            }());
            exports_1("AppSPAComponent", AppSPAComponent);
        }
    }
});
//# sourceMappingURL=app-singlepageapp.component.js.map