System.register(["angular2/core", "./zippy.component"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AppZippyComponent = (function () {
                function AppZippyComponent() {
                }
                AppZippyComponent = __decorate([
                    core_1.Component({
                        selector: "app-zippy",
                ...
                return AppZippyComponent;
            }());
            exports_1("AppZippyComponent", AppZippyComponent);
        }
    }
});
